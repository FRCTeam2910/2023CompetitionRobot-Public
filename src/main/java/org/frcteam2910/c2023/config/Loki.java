...
public class Loki implements RobotConstants {
    ...
    private final int BACK_LEFT_DRIVE_MOTOR_ID = 5;
    ...
    public static final int SHOULDER_MOTOR_ONE_ID = 9;
    ...
    private final boolean USING_SECONDARY_DRIVE_MOTOR = false;

    private PortConfiguration portConfiguration = new PortConfiguration();

    // Drivetrain Constants
    private final double FRONT_LEFT_STEER_OFFSET_RAD = -Math.toRadians(248.81 - 180.0); // old 68.6458
    private final double FRONT_RIGHT_STEER_OFFSET_RAD = -Math.toRadians(122.51 + 180.0); // old 302.6074
    private final double BACK_LEFT_STEER_OFFSET_RAD = -Math.toRadians(49.39 + 180.0); // old 229.8340
    private final double BACK_RIGHT_STEER_OFFSET_RAD = -Math.toRadians(65.21 + 180.0); // old 245.5664
